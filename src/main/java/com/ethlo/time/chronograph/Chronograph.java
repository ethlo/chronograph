package com.ethlo.time.chronograph;
...
import com.ethlo.time.chronograph.output.json.JsonOutputFormatter;
import com.ethlo.time.chronograph.internal.MutableTaskInfo;
import com.ethlo.time.chronograph.internal.RateLimitedTaskInfo;
...
public class Chronograph
{
    ...
    /**
     * Outputs the data in a format that may change over time. Please use a @{@link OutputFormatter} to have more control over the output
     *
